      ...
      <div className="mx-auto max-w-md px-6 pb-20 pt-14">
        ...
        <div className="mt-4 space-y-6">
          ...
          <Section title="1. Not Medical Advice">
            ...
            <p>
              All calorie and macronutrient estimates are generated by artificial intelligence and are approximations only. AI-generated content may be inaccurate, incomplete, biased, or not applicable to your specific circumstances. You should not rely on the App to diagnose, treat, manage, or prevent any health condition.
            </p>
            <p>
          ...
          <Section title="2. Eating Disorders and Vulnerable Users">
            <p>
              WhatYouAte is not intended for use by individuals who have or are at risk of developing an eating disorder, including but not limited to anorexia nervosa, bulimia nervosa, binge eating disorder, or any other disordered eating pattern. If you have a history of or are currently experiencing an eating disorder, please consult a qualified healthcare professional before using this App.
            </p>
            <p>
              The App is not designed to encourage, support, or facilitate restrictive eating, extreme caloric deficits, or any behaviour that may be harmful to your physical or mental health. If you feel the App is negatively affecting your relationship with food, stop using it and seek professional support.
            </p>
            <p>
              If you or someone you know is struggling with an eating disorder, contact the National Eating Disorder Information Centre (NEDIC) at 1-866-633-4220 or visit nedic.ca.
            </p>
          </Section>
        ...
        <div className="mt-4 space-y-6">
          ...
          <Section title="19. Third-Party Service Providers">
            ...
            <ul className="mt-1.5 space-y-1.5 list-disc list-inside">
              ...
              <li><span className="font-medium text-ink/80">Anthropic</span>: AI-powered meal photo analysis and nudge generation.</li>
              <li><span className="font-medium text-ink/80">OpenAI</span>: AI-powered meal photo analysis (used as a fallback provider).</li>
              <li><span className="font-medium text-ink/80">RevenueCat</span>: subscription and in-app purchase management.</li>
              <li><span className="font-medium text-ink/80">Vercel</span>: application hosting and infrastructure.</li>
              <li><span className="font-medium text-ink/80">Apple</span>: payment processing for App Store subscriptions.</li>
            </ul>
          ...
          <Section title="26. Health Information Sources">
            <p>
              Nutritional insights, nudges, and recommendations generated by WhatYouAte are informed by publicly available dietary reference materials, including the{" "}
              <a href="https://www.dietaryguidelines.gov" className="text-primary underline-offset-2 hover:underline" target="_blank" rel="noopener noreferrer">U.S. Dietary Guidelines for Americans</a>
              {" "}(U.S. Department of Agriculture and U.S. Department of Health and Human Services) and{" "}
              <a href="https://www.nih.gov/health-information" className="text-primary underline-offset-2 hover:underline" target="_blank" rel="noopener noreferrer">NIH Health Information</a>
              {" "}(National Institutes of Health). Calorie and macronutrient estimates are AI-generated approximations and are not clinical assessments. Nothing in the App constitutes medical or dietetic advice.
            </p>
            <p>
              Apple Health data (steps, sleep, workouts) is accessed via the HealthKit framework with your explicit permission and is used solely to inform the personalization of your AI coach messages.
            </p>
          </Section>

          <Section title="28. Contact">
            <p>
