    ...
    <div className="min-h-screen bg-surface">
      ...
      {showFeedbackToast && (
        <div className="fixed inset-x-0 bottom-6 z-50 flex justify-center px-5">
          <div className="rounded-full border border-primary/25 bg-primary/10 px-5 py-2.5 text-sm font-medium text-ink/80 shadow-[0_8px_24px_rgba(15,23,42,0.15)]">
      ...
      {showSavedToast && (
        <div className="fixed inset-x-0 bottom-6 z-50 flex justify-center px-5">
          <div className="rounded-full border border-primary/25 bg-primary/10 px-5 py-2.5 text-center text-sm font-medium text-ink/80 shadow-[0_8px_24px_rgba(15,23,42,0.15)]">
            Saved
          </div>
        </div>
      )}
