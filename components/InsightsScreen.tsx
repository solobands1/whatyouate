        ...
        <Card style={riseIn(barsReady, 0)}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {!hasEnoughData && <p className="text-[10px] font-semibold uppercase tracking-wide text-primary/60">Example</p>}
              <button
                type="button"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                  ...
                  <p className="text-[10px] text-ink/60">Food</p>
                </div>
                <div className="flex items-center gap-1">
                  <div className="h-2 w-4 rounded-sm bg-primary/35" />
                  <p className="text-[10px] text-ink/60">Supplements</p>
                </div>
              </div>
            </div>
          </div>
          <div className={`mt-4${!hasEnoughData && !isDemoMode ? " opacity-50" : ""}`}>
