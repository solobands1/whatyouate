...
export default function HomeScreen() {
  ...
  const greetingIcon = (phase: "morning" | "afternoon" | "evening") =>
    phase === "morning" ? (
      <svg viewBox="0 0 24 24" className="h-9 w-9" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v2M6.1 6.9l1.2 1.6M17.9 6.9l-1.2 1.6M4.4 12.5l-1.9-0.6M19.6 12.5l1.9-0.6M8.1 16A4 4 0 1 1 15.9 16" /><path strokeWidth="1.3" d="M1.5 16h21M7 19h10" /></svg>
    ) : phase === "afternoon" ? (
