            ...
            {streak >= 1 && (() => {
              ...
              return (
                <div className="flex flex-col items-end gap-1">
                  <div className={`flex items-center gap-1.5 rounded-full px-3.5 py-1.5 bg-primary/10 ${streakSaverInfo ? "animate-wiggle" : ""} ${streakBouncing ? "animate-streak-bounce" : ""}`}>
                    <svg width="18" height="20" viewBox="0 0 13 15" fill="none" aria-hidden="true" className={atRisk ? "" : "animate-flame"}>
                      <defs>
