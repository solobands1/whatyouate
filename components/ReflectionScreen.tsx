      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col px-5 pb-24 safe-top">
        ...
        {loading && sorted.length === 0 ? (
          ...
          <>
            ...
            <div className="mb-4 flex items-center gap-3 rounded-2xl border border-primary/15 bg-primary/[0.05] px-4 py-3.5" style={riseIn(barsReady, 0)}>
              ...
              <p className="text-[13px] leading-relaxed text-ink/80">Your nightly reflection opens at 5pm each evening, and we&apos;ll remind you at 7pm. Complete your first one to start seeing your data here.</p>
            </div>
