  ...
  const patternsTourSteps: Step[] = [
    {
      ...
      content: (
        <div>
          ...
          <p>Your longer-term view of what&apos;s affecting how you feel.</p>
          <p style={{ marginTop: 10 }}>Your Coach highlights a few insights from what you log, and they sharpen each time you check back.</p>
        </div>
      ),
    },
    {
